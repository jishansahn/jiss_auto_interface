...
def main_proc():
    ...
    try:
        ...
        for i in range(table.nrows):
            ...
            req_data2["ins_start_date"] = xlrd.xldate_as_datetime(table.cell(i, 13).value,0).strftime("%Y-%m-%d")
            req_data2["force_start_date"] = xlrd.xldate_as_datetime(table.cell(i, 14).value,0).strftime("%Y-%m-%d")
